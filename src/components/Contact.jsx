...
const Contact = () => {
  return (
    <div id='Contact' className='max-w-[1040px] m-auto md:pl-20 =-4 py-16'>
        <h1 className='py-4 text-4xl font-bold text-center text-[#0015be]'>
            Contact</h1>
            <form action="https://getform.io/f/6f82cb18-7532-49af-aed4-1c65f81f4014" method='POST' encType='multipart/form-data'>
